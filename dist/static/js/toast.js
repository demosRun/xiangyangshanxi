...
owo.tool.toast = function (text, config) {
  ...
  // 设置样式
  toast.style.cssText = "position:fixed;z-index:999;pointer-events: none;background-color:rgba(0, 0, 0, 0.8);bottom:9%;border-radius:" + parseInt(fontSize / 3) + "px;left:50%;transform: translateX(-50%) translate3d(0, 0, 0);margin:0 auto;text-align:center;color:white;max-width:60%;padding:" + parseInt(fontSize / 2) + "px 10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;user-select: none;font-size:" + fontSize + 'px;'
